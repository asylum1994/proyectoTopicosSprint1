<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="monto" class="form-control @error('monto') is-invalid @enderror" value="{{ old('monto', $juego?->monto) }}" id="monto" placeholder="Monto">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_ini" class="form-control @error('fecha_ini') is-invalid @enderror" value="{{ old('fecha_ini', $juego?->fecha_ini) }}" id="fecha_ini" placeholder="Fecha Ini">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_fin" class="form-control @error('fecha_fin') is-invalid @enderror" value="{{ old('fecha_fin', $juego?->fecha_fin) }}" id="fecha_fin" placeholder="Fecha Fin">
